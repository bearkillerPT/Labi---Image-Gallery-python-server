...
O resultado final deste projeto é um \textit{website} funcional com todas as especificações do guião. Para além disso, a utilização é extremamente intuitiiva para o utilizador e, com a compatibilidade de ecrâs é, acima de tudo, útil. Com isto, podemos dizer que o projeto foi bem suceiddo.
